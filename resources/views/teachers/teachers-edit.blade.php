                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <div class="mb-4">
                                    <img src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('assets/auth/images/users/avatar.png') }}"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control" id="branch_email" name="branch_email"
                                            value="{{ old('branch_email', $user->branch_email) }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="branch_phone" name="branch_phone"
                                            value="{{ old('branch_phone', $user->branch_phone) }}"
