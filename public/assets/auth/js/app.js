const base = window.Laravel.assetBase;

!(function (n) {
    "use strict";
    function s() {
        for (
            var e = document.getElementById("topnav-menu-content").getElementsByTagName("a"), t = 0, n = e.length;
            t < n;
            t++
        )
            "nav-item dropdown active" === e[t].parentElement.getAttribute("class") &&
                (e[t].parentElement.classList.remove("active"), e[t].nextElementSibling.classList.remove("show"));
    }
    function t(e) {
        1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e
            ? (n("html").removeAttr("dir"),
              ...
              n("#bootstrap-style").attr("href",base+"assets/auth/css/bootstrap.min.css"),
              n("#app-style").attr("href", base+"assets/auth/css/app.min.css"),
              sessionStorage.setItem("is_visited", "light-mode-switch"))
            : 1 == n("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e
              ? (n("html").removeAttr("dir"),
                n("#light-mode-switch").prop("checked", !1),
                n("#rtl-mode-switch").prop("checked", !1),
                n("#bootstrap-style").attr("href", base+"assets/auth/css/bootstrap-dark.min.css"),
                n("#app-style").attr("href",base+"assets/auth/css/app-dark.min.css"),
                sessionStorage.setItem("is_visited", "dark-mode-switch"))
              : 1 == n("#rtl-mode-switch").prop("checked") &&
                "rtl-mode-switch" === e &&
                (n("#light-mode-switch").prop("checked", !1),
                n("#dark-mode-switch").prop("checked", !1),
                n("#bootstrap-style").attr("href", base+"assets/auth/css/bootstrap-rtl.min.css"),
                n("#app-style").attr("href", base+"assets/auth/css/app-rtl.min.css"),
                n("html").attr("dir", "rtl"),
